    ...
    <div class="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="text-center space-y-2">
                <div class="inline-flex p-2.5 rounded-2xl bg-court-surface border border-court-border mb-2 shadow-[0_0_25px_rgba(0,255,135,0.2)]">
                    ...
                    <div class="space-y-1.5" x-data="{ captchaUrl: '{{ route('captcha') }}' }">
                        ...
                        <div class="flex items-center gap-2.5">
                            <div class="relative group cursor-pointer border border-court-border rounded overflow-hidden flex-shrink-0 bg-court-navy hover:border-stadium-emerald transition-all shadow-inner"
                                ...
                                <img :src="captchaUrl" alt="Kode Keamanan" class="h-11 w-36 object-contain block select-none">
                                <div class="absolute inset-0 bg-stadium-emerald/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                                    <span class="material-symbols-outlined text-xs text-stadium-emerald bg-court-navy/80 rounded-full p-0.5">sync</span>
                                </div>
                            </div>
                            <button type="button"
                                @click="captchaUrl = '{{ route('captcha') }}?v=' + Date.now()"
